...
<div class="container">
	<h2 class="page-header">Edite Job Listing</h2>
	<form method="post" action="edite.php?id=<?php echo $job->id ;?>">
		<div class="form-group">
			...
			<textarea class="form-control" name="description"><?php echo $job->discription; ?>"</textarea>  
